...
public class DocumentsController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<DocumentsDTO> getById(@PathVariable String id) throws DocumentNotFoundException {
        return new ResponseEntity<>(documentService.getById(id), HttpStatus.OK);
    }

    @PostMapping("{userId}")
    public ResponseEntity<DocumentsDTO> create(@PathVariable String userId, @RequestBody DocumentsDTO document)
    ...
    public ResponseEntity<DocumentsDTO> update(
            @PathVariable String docId,
            @PathVariable String userId,
            @RequestBody DocumentsDTO document
